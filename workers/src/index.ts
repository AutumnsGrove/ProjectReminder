...
/**
 * CORS Middleware
 * Enables credentials for Cloudflare Access cookies
 */
app.use('/*', cors({
  origin: [
    'http://localhost:3077',
 ...
 * Validates CF-Access-Authenticated-User-Email header set by Cloudflare Zero Trust
 */
const authMiddleware = async (c: any, next: any) => {
  ...
  c.set('cfAccessUser', { email: cfAccessEmail })
  await next()
}
...
/**
 * =============================================================================
 * Authentication Endpoints (Cloudflare Access)
 * =============================================================================
 */

/**
 * GET /api/auth/status
 * Check Cloudflare Access authentication status
 */
